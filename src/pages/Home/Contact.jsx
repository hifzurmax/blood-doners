            ...
            <div className="grid grid-cols-1 md:grid-cols-12 border">
                <div className="bg-main md:col-span-4 p-10 text-white">
                    ...
                    <div className="flex items-center mt-5">
                        ...
                        <span className="text-sm items-center flex"><FaPhone className="mr-2"></FaPhone> +93 749 99 65 50</span>
                    </div>
                    <div className="flex items-center mt-5">
                    <span className="text-sm flex items-center"><FaEnvelope className="mr-2"></FaEnvelope> blood@donors.com</span>
                    </div>
                ...
                <form className="md:col-span-8 p-10">
                    ...
                    <div className="flex flex-wrap -mx-3 mb-6">
                        ...
                        <div className="flex justify-between w-full px-3">
                            ...
                            <button
                                className="shadow bg-second hover:bg-indigo-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-6 rounded"
                                >
                                Send Message
                            </button>
                        </div>
