...
import { FaCalendarAlt, FaClock, FaMoneyCheckAlt } from "react-icons/fa";
...
const ViewRequest = () => {
    ...
    return (
        <div className="mb-10 mx-auto ml-10 mr-10">
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <label htmlFor="my_modal_7" className="btn px-10 bg-second text-white font-semibold text-lg hover:bg-main"><FaHandHoldingDroplet></FaHandHoldingDroplet>Change the status to inprogress</label>
            </div>
