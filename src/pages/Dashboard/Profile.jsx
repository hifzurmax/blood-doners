...
const Profile = () => {
    ...
    return (
        <div className="md:flex">
            <div className="hero min-h-[32vh] md:w-1/3 md:ml-4 rounded-lg" style={{ backgroundImage: 'url(https://daisyui.com/images/stock/photo-1507358522600-9f71e620c44e.jpg)' }}>
